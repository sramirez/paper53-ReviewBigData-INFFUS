...
Another interesting approaches from the boosting perspective \cite{schapire99brief} were AdaBoost.PL, LogitBoost.PL and MultiBoost.PL \cite{Palit12-Boost}. These include and ensemble of ternary classifiers \cite{schapire99confidence}, or an ensemble of ensembles. The methodology in this case is exactly the same than for XXX.
